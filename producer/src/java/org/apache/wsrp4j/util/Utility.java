...
public class Utility
{
     ...
     **/
    public static Properties loadPropertiesFromFile(String fileName) throws WSRPException
    {

        try
        {
            // read in .properties-file
            InputStream in = Utility.class.getClassLoader().getResourceAsStream(fileName);
