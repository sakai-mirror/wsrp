...
public class LogManager
{
    ...
    */
    private LogManager()
    {
        ...
        try
        {
            ...
            int userDefinedGlobalLevel =
                getLevelFromString(wsrp4jLevels.getProperty(GLOBAL_LOG_LEVEL_PROPERTY));
            ...
            org.apache.log4j.Logger.getLogger(this.getClass()).info(
                "Global log level: " + this.getLevelAsString(globalLogLevel));
    ...
    */
    public Logger getLogger(Class aClass)
    {
        ...
        int userDefinedLevel = getLevelFromString(wsrp4jLevels.getProperty(propertyName));
