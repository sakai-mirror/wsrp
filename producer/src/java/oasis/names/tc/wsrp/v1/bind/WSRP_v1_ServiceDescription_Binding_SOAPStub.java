...
public class WSRP_v1_ServiceDescription_Binding_SOAPStub extends org.apache.axis.client.Stub implements oasis.names.tc.wsrp.v1.intf.WSRP_v1_ServiceDescription_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "ServiceDescription"));
        oper.setReturnClass(oasis.names.tc.wsrp.v1.types.ServiceDescription.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "getServiceDescriptionResponse"));
    ...
    public oasis.names.tc.wsrp.v1.types.ServiceDescription getServiceDescription(oasis.names.tc.wsrp.v1.types.GetServiceDescription getServiceDescription) throws java.rmi.RemoteException, oasis.names.tc.wsrp.v1.types.InvalidRegistrationFault, oasis.names.tc.wsrp.v1.types.OperationFailedFault {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("", "getServiceDescription"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {getServiceDescription});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (oasis.names.tc.wsrp.v1.types.ServiceDescription) _resp;
            } catch (java.lang.Exception _exception) {
                return (oasis.names.tc.wsrp.v1.types.ServiceDescription) org.apache.axis.utils.JavaUtils.convert(_resp, oasis.names.tc.wsrp.v1.types.ServiceDescription.class);
            }
        }
