...
public class WSRP_v1_Markup_Binding_SOAPStub extends org.apache.axis.client.Stub implements oasis.names.tc.wsrp.v1.intf.WSRP_v1_Markup_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "getMarkup"), new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", ">getMarkup"), oasis.names.tc.wsrp.v1.types.GetMarkup.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        ...
        oper.addParameter(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "releaseSessions"), new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", ">releaseSessions"), oasis.names.tc.wsrp.v1.types.ReleaseSessions.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        ...
        oper.addParameter(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "initCookie"), new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", ">initCookie"), oasis.names.tc.wsrp.v1.types.InitCookie.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("urn:oasis:names:tc:wsrp:v1:types", "ReturnAny"));
        oper.setReturnClass(oasis.names.tc.wsrp.v1.types.ReturnAny.class);
